...
# 3. HQ dash — port 8850 (real file is qsb_hq_claude_dash.py; old guard checked a
#    non-existent qsb_hq_dash.py so this silently skipped every boot — fixed 2026-07-08)
