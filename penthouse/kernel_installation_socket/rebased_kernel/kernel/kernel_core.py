...
# REBASE CHANGE: imports rewired from absolute 'from kernel.X' to relative 'from .X'
# DO NOT instantiate QSBKernelCore — dormant, non-executing package.
from .identity_core import IdentityCore
from .axiom_core import AxiomCore
from .continuity_core import ContinuityCore
from .symbolic_core import SymbolicLogicCore
